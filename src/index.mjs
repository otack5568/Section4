...
// console.log(num1);
// console.log(num2);
// console.log(arr3);//末尾3つをまとめて受け取った
...
// || は、左側がfalseなら右側を返す、という意味(jsではNULLはfalse判定)
const num = 100;
const fee = num || "金額未設定です";
console.log(fee);

//&& は、左側はtrueなら右側を返す、という意味
const num2 = null;
